...
public class AltitudeSumManagerTest {
    ...
    public void getAltitudeGainLoss_downhill() {
        ...
        // then
        Assert.assertEquals(0f, subject.getAltitudeGainM(), 0.01);
        Assert.assertEquals(48.0, subject.getAltitudeLossM(), 0.01);
    }
    ...
    public void sensorUnavailable() {
        ...
        // then
        Assert.assertNull(subject.getAltitudeGainM());
        Assert.assertNull(subject.getAltitudeLossM());
    }
}